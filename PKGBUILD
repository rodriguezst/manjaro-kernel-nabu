...
source=( "http://www.kernel.org/pub/linux/kernel/v6.x/${_srcname}.tar.xz"
         ...
         "0020-NABU-Add-wcd9340-and-microphone-dais.patch"
         "0021-drm-msm-dsi-change-sync-mode-to-sync-on-DSI0-rather-.patch"
         "0022-drm-msm-dpu1-improve-support-for-active-CTLs.patch"
         "0023-drm-msm-dpu1-use-one-active-CTL-if-it-is-available.patch"
         "0024-drm-msm-dpu-populate-has_active_ctls-in-the-catalog.patch"
         "0025-drm-msm-dpu1-dpu_encoder_phys_-proper-support-for-ac.patch"
         "0026-drm-panel-nt36523-enable-prepare_prev_first.patch"
         "0027-input-nt36xxx-Enable-pen-support.patch"
         "0028-clk-qcom-clk-regmap-Add-udelay-in-clk_enable_regmap-.patch"
         "0029-drm-msm-dpu-try-multirect-based-on-mdp-clock-limits.patch"
         "0030-drm-msm-dpu-Fix-dpu-sspp-features-for-sm8150.patch"
         "0031-drm-panel-nt36523-Enable-120fps-for-nabu-csot.patch"
         "0032-ASoC-qcom-sm8150-Fix-compilation-in-v6.7.0.patch"
         ...
         "0039-bluetooth-hci_qca-HACK-Fix-bt-addr-never-being-set.patch"
         "0040-serial-geni_serial-Revert-to-FIFO-only-for-now.patch" )
